                  ...
                  @foreach ($actividades as $actividad)
                     <tr>
                        ...
                        <td align="right" style="width:568.89px;">
                           <a href="{{ url('usuario/actividades/editAct/'.$actividad->id) }}" class="btn btn-warning btn-xs">
               ...
               <tbody class="tb-enterprise tb-data">          
                  @foreach ($empresas as $empresa)
                     <tr>
                        ...
                        <td align="right" style="width:568.89px;">
                           <a href="{{ url('usuario/actividades/editEmp/'.$empresa->id) }}" class="btn btn-warning btn-xs">
                              <i class="fa fa-pencil-square-o"></i> Editar
                           </a>                           
                        </td>
                     </tr>
