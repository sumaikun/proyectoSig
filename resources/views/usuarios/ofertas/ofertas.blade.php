...
@section('menu_lateral')
   @include('usuarios.layouts.menu_lateral', array('op'=>'ofertas'))
@stop
...
@section('contenido')
<h3 class="page-header"><i class="fa fa-cube"></i> Ofertas SIG <small>PortalSIG</small></h3>
	...
	<div class="content-container clearfix">
   	<div class="col-md-12">
         <h4 class="content-title">CONSECUTIVOS OFERTAS SIG</h4>
        	...
        	<form action="ofertas" enctype="multipart/form-data" name="form2" id="form2" method="post">
         ...
         <div class="row">
            ...
            <div class="col-lg-2">
               <div class="form-group">
                  <a class="btn btn-success btn-block" href="{{ url('usuario/exportar_ofertas') }}"/>
...
<div class="tab-pane" id="compose">
   <div class="content-container clearfix">
      <div class="col-md-12">
   	...
   	<form action="save_oferta" enctype="multipart/form-data" name="form1" id="form1" method="post" onsubmit="return validar()">
...
<div class="modal fade bs-example-modal-lg" id="modalid" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
		...
		<form action="update_oferta" enctype="multipart/form-data" name="form3" id="form3" method="post">
         ...
         <div class="row">
         	...
         	<div class="col-lg-2">
               <div class="form-group">
               	...
               	<input type="text" name="geofer_valor_inicial_upd" id="geofer_valor_inicial_upd" class="form-control input-sm" placeholder="12019223">
               </div>
            </div>
            ...
            <div class="col-lg-2">
               <div class="form-group">
               	...
               	<input type="text" name="geofer_ult_valor_cot_upd" id="geofer_ult_valor_cot_upd" class="form-control input-sm" placeholder="12019223">
               </div>
            </div>
            ...
            <div class="col-lg-2">
               <div class="form-group">
               	...
               	<input type="text" name="geofer_val_factura_upd" id="geofer_val_factura_upd" class="form-control input-sm" placeholder="12019223">
               </div>
            </div>
...
-           $('#'+idobject).append('<option value="'+value.geofer_consecutivo+'">'+value.geofer_consecutivo+'</option>');
      ...
      // $('#'+idobject).selectmenu("refresh", true); Este codigo me arroja error con el preload
