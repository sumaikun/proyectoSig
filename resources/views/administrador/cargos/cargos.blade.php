...
<section class="content-header">
	<h1><i class="fa fa-puzzle-piece"></i> Gestión de Cargos <!-- <small>Nuevo usuario</small> --></h1>
   <ol class="breadcrumb">
   	<li><a href="{{ url('admin/cargos') }}"><i class="fa fa-puzzle-piece"></i> Gestión de cargos</a></li>
...
<div class="col-lg-10 col-lg-offset-1 custyle">
   <div class="panel panel-default">
      ...
      <div class="panel-heading">
         <strong><i class="fa fa-list"></i> Listado de cargos</strong>
      </div>

      
      <div class="panel-body">
         <a href="#" class="btn btn-primary btn-xs pull-right" data-toggle="modal" data-target="#myModal"><b>+</b> Agregar nuevo cargo</a>      
         ...
         <div class="modal-body">
            ...
            <div class="row">
               <div class="col-lg-6">
                  ...
                  <input type="text" name="carg_nombre" id="carg_nombre" class="form-control input-sm" placeholder="profesional de campo" autofocus required>
               </div>
               <div class="col-lg-6">
