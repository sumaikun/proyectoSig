...
<section class="content-header">
	<h1><i class="fa fa-search"></i> Comunicaciones PRE <small>Administrador Portalsig</small></h1>
   <ol class="breadcrumb">
   	<li><a href="{{ url('admin/ofertas_sig') }}"><i class="fa fa-book"></i> Comunicaciones PRE</a></li>
   ...
   <div class="content-container clearfix">
      <div class="col-md-12">
         ...
         <div class="row">
            ...
            <div class="col-lg-2">
               <div class="form-group">
                  <a class="btn btn-success btn-block" href="{{ url('admin/exportar_cc') }}"/>
...
<div class="tab-pane" id="compose">
   <div class="content-container clearfix">
      ...
      <div class="col-md-12">
         ...
         <form name="form1" id="form1" action="guardar_consecutivo" method="post">
