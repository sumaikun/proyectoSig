            ...
            <div class="row">
               ...
               @foreach($consecutivos as $consecutivo)
                  <tr>
                     ...
                     <td>@if(isset($consecutivo->documentos->versiones()->where('gdver_estado', 'activo')->where('empresa', $consecutivo->empresa)->first()->gdver_descripcion)){{ $consecutivo->documentos->versiones()->where('gdver_estado', 'activo')->where('empresa', $consecutivo->empresa)->first()->gdver_descripcion }}@endif</td>
