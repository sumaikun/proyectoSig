...
<section class="content-header">
	<h1>
      <i class="fa fa-check-square-o"></i> Permisos usuario - documentos 
   </h1>
   <ol class="breadcrumb">
   	<li>
      ...
      <li class="active">Permisos Usuario - doc</li>
   </ol>
</section>
...
<form action="reg_permisos" id="form1" name="form1" method="post" onsubmit="return validar()">
...
function buscar_permisos(id_udu){
   // alert(id_udu);
