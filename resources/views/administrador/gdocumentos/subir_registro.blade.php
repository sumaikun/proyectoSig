...
<div class="panel panel-primary">
   ...
   <div class="panel-body">
         ...
         <div class="well well-sm">
            <div class="row">
               ...
               @foreach($consecutivos as $consecutivo)
                  <tr>
                     <td>
                        <input type="radio" name="gdcon_id" class="gdcon_id" id="{{$consecutivo->gdcon_id}}" value="{{$consecutivo->gdcon_id}}" required>
                     </td>
      ...
      <div class="col-lg-10" style="border-right:2px solid;">
      ...
      <div class="col-lg-2 text-center">
         <button type="button" class="btn btn-danger btn-circle btn-xl" onclick="anular()">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-question-circle"></i> Razón por la cual cancela el consecutivo</h4>
         </div>
         ...
         <div class="well well-sm">
            <div class="row">
               <div class="col-lg-12">
                  Explique las razones por la cual no se utilizó el consecutivo
               </div>
