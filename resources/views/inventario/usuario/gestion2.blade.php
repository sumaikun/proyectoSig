            ...
            <tbody>
              @foreach($consumibles as $consumible)
                <tr>  
                  ...
                  <td>@if(Session::get('man_consumibles')!=null)<a href="#" data-toggle="modal" onclick="edit_element({{$consumible->id}})" title="editar" data-target="#myModal"><i class="fa fa-pencil" aria-hidden="true"></a></i> <a href="consumibledelete/{{$consumible->id}}" onclick="return confirm_action()" title="Eliminar" style="margin-left: 5px;"><i class="fa fa-trash-o" aria-hidden="true"></i></a>@endif</td>  
                </tr>  
              @endforeach
            </tbody>
         </table>
