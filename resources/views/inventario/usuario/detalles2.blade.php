...
<section class="content-header">
  ...
  <h1><i class="fa fa-plus-circle"></i> Detalles de Mantenimiento  {{$detalles}}<!-- <small>Nuevo usuario</small> --></h1>
   <ol class="breadcrumb">
   ...
   <div class="panel panel-primary">
      ...
      <div class="panel-body">
        ...
        <tbody>
          <tr>
            <td> {{ $registro->id }} </td>
            <td>  <span class="date{{ $registro->id }}">{{ $registro->fecha }}</span> @if(Session::get('cambiar_mantenimiento')!=null)<a href="#" onclick="assign_id({{ $registro->id }})" data-toggle="modal"  title="editar" data-target="#myModal"><i class="fa fa-pencil" aria-hidden="true"></a></i>@endif</td>
            <td> <span class="comment{{ $registro->id }}">{{ $registro->info_extra }}</span> @if(Session::get('cambiar_mantenimiento')!=null)<a href="#" onclick="assign_id({{ $registro->id }})" data-toggle="modal"  title="editar" data-target="#myModal2"><i class="fa fa-pencil" aria-hidden="true"></a></i>@endif</td>
            ...
            <td>@if(Session::get('inventario_eliminar')!=null) <a href="#" onclick="return confirm_action()" title="Eliminar" style="margin-left: 5px;"><i class="fa fa-trash-o" aria-hidden="true"></i></a>@endif</td>
          </tr>
        </tbody>
      </table>    
      </div>
